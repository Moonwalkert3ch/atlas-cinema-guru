...
import home from "../images/icons8-folder-50.png";
import favorite from "../images/icons8-star-48.png";
import watchLater from "../images/icons8-clock-48.png";
  ...
  return (
    <div onMouseOver={fetchActivities} className="bg-teal-500 fixed top-[60px] left-0 h-full px-6 py-4 flex flex-col items-start space-y-4 group z-[1000]">
        <Link href="/" className="flex items-center space-x-2">
                <Image src={home} alt="Home Folder" className="w-6 h-6 icon-white" />
        ...
        <Link href="/dashboard/favorite" className="flex items-center space-x-2">
                <Image src={favorite} alt="Favorite" className="w-6 h-6 icon-white" />
        ...
        <Link href="/dashboard/watchLater" className="flex items-center space-x-2">
                <Image src={watchLater} alt="Watch Later" className="w-5 h-5 icon-white" />
