...
import favoriteIcon from "../images/icons8-star-48.png";
import watchLaterIcon from "../images/icons8-clock-48.png";
            ...
            <div className="absolute top-6 right-6 flex space-x-0 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
              <button className="p-1" onClick={() => toggleFavorite(title.id)}>
                <Image
                  src={favoriteIcon}
                  alt="Favorite"
                  className={`w-6 h-6 ${title.favorited ? 'icon-white-filled' : 'icon-white'}`}
                />
              </button>
              <button className="p-1" onClick={() => toggleWatchLater(title.id)}>
                <Image
                  src={watchLaterIcon}
                  alt="Watch Later"
                  className={`w-6 h-6 ${title.watchLater ? 'icon-white-filled' : 'icon-white'}`}
                />
              </button>
            </div>
            {/* card title, genre, and synopsis */}
